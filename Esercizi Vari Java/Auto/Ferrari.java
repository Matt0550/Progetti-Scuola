...
public class Ferrari extends Auto {
    ...
    public Ferrari(String marca, int cilindrata, int cavalli, double prezzo, String colore) { // Costruttore della classe figlio
    ...
    public void accelera() { // Implemento il metodo astratto (sovrascrivo il metodo)
        System.out.println("Ferrari sta accelerando!");
    }
}