...
class Program {
    ...
    double calcoloDetrazioniLavoroDipendente(double imponibileFiscale, double reddito) {
        double detrazione = 144;
        imponibileFiscale -= 1154;
        if(imponibileFiscale > 1154 && imponibileFiscale < 2154) {
            detrazione += 146 + 92 *(2154 - reddito)/100;
            return detrazione;
        } else {
            return detrazione;
        }
    ...
    double calcoloDetrazioniConiugeCarico(float imponibileFiscale) {//Funzione che mi serve per calcolare le detrazioni coniuge a carico
    	double detrazioni = 0;
    	detrazioni += 67;
    	imponibileFiscale -= 1154;
    ...
    void home() { 
        ...
        cout<<"Inserisci il reddito: "<<greenColorCode;
        cin>>reddito;
        cout<<resetColorCode;
        ...
        double DetrazioniFamiliari = calcoloDetrazioniFamiliari(imponibileFiscale);
        ...
        double stipendioNetto = stipedioLordo - ritenutePrevidenziale - impostanetta;
        
        
        
        cout << "Il tuo stipendio netto: " << stipendioNetto;
